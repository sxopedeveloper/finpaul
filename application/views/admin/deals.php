											...
											foreach ($leads as $lead){
												...
												<td>
													<a href="<?php echo site_url("deal/pdf_export/".$lead->id_fq_account); ?>"  target="_blank">
														<i class="fa fa-file-pdf-o" data-toggle="tooltip" data-placement="top" title="Client Purchase Order"></i>
													</a>
												</td>
												<td>
													<a href="<?php echo site_url("deal/dealer_invoice_pdf/".$lead->id_fq_account); ?>"  target="_blank">
														<i class="fa fa-file-pdf-o" data-toggle="tooltip" data-placement="top" title="Dealer Purchase Order"></i>
													</a>
												</td>
												<?php
													}
